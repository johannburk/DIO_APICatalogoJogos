 ...
 public class JogoSqlServerRepository : IJogoRepository
    {
        ...
        public async Task<List<Jogos>> Obter(int pagina, int quantidade)
        {
            ...
            SqlCommand slqCommand = new SqlCommand(comando,sqlConnection);
            SqlDataReader sqlDataReader = await slqCommand.ExecuteReaderAsync();
        ...
        public async Task<Jogos> Obter(Guid id)
        {
            Jogos jogo = null;
        ...
        public async Task Inserir (Jogos jogo)
        {
        ...
        public async Task Atualizar(Jogos jogo)
        {
